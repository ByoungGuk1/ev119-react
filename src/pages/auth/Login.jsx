...
const ERROR_MESSAGES = {
  REDIS_DOWN: '현재 서버(세션/토큰 저장소) 상태 문제로 소셜 로그인이 불가합니다. 잠시 후 다시 시도해주세요.',
  REDIS_ERROR: '소셜 로그인 처리 중 저장소 오류가 발생했습니다. 잠시 후 다시 시도해주세요.',
  OAUTH_EMAIL_MISSING: '이메일 제공에 동의해야 소셜 로그인을 사용할 수 있습니다.',
  OAUTH_DB_NOT_FOUND: '소셜 계정이 회원 DB에 없습니다. 관리자에게 문의해주세요.',
